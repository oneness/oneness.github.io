...
* Personal Statement
  I enjoy engineering information systems just works for end user and
  optimized for developer productivity, which can only be achieved by
  being vigilant about keeping IT as simple as IT can be. If you are
  into Clojure, F#, Ada, Smalltalk or other Programming Languages that
  I should check out, drop me a line via ktuman at acm dot org.
